        ...
        let row = NodeHealthRow {
            ...
            content_repos: vec![
                RepoUsage {
                    ...
                    used_bytes: 118 * crate::bytes::GIB,
                    total_bytes: 190 * crate::bytes::GIB,
                    free_bytes: 72 * crate::bytes::GIB,
                    utilization_percent: 62,
                },
                RepoUsage {
                    identifier: "/data/c2".into(),
                    used_bytes: 78 * crate::bytes::GIB,
                    total_bytes: 190 * crate::bytes::GIB,
                    free_bytes: 112 * crate::bytes::GIB,
                    utilization_percent: 41,
                },
            ],
            flowfile_repo: Some(RepoUsage {
                identifier: "/data/ff".into(),
                used_bytes: 9 * crate::bytes::GIB,
                total_bytes: 50 * crate::bytes::GIB,
                free_bytes: 41 * crate::bytes::GIB,
                utilization_percent: 18,
            }),
            provenance_repos: vec![RepoUsage {
                identifier: "/data/p1".into(),
                used_bytes: 124 * crate::bytes::GIB,
                total_bytes: 200 * crate::bytes::GIB,
                free_bytes: 76 * crate::bytes::GIB,
                utilization_percent: 62,
            }],
