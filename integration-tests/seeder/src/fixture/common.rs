//! Shared fixture helpers — PG / processor / port / connection creation
//! plus state-transition polling. Previously embedded inside healthy.rs;
//! extracted so non-healthy fixture modules don't have to depend on a
//! sibling fixture module that's slated for deletion.

use std::time::Duration;

use nifi_rust_client::dynamic::{DynamicClient, types};

use crate::entities::{make_connection, make_pg, make_port};
